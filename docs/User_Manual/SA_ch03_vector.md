...
A list of [Datum Specifications](proj_datums.html)??? which can be used in datum transformation and a list of [Named Ellipses](proj_ellipses.html)??? are available. You may specify the ellipsoid parameters as shown in the following examples:
