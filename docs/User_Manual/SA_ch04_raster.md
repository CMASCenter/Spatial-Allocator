...
-   MODIS land cover data sets – can be obtained from [http://ladsweb.nascom.nasa.gov/ data/search.html](http://ladsweb.nascom.nasa.gov/data/search.html). The tool can process MCD12Q1 data at 500 m from Combined Terra and Aqua MODIS, or can process MOD12Q1 data at 1 km from Terra MODIS.
