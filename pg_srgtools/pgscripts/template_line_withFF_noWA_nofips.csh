...
printf "CREATE TABLE public.wp_cty_${surg_code}_${grid} AS (\n" >> ${output_dir}/temp_files/${surg_code}_create_wp_cty.sql
...
printf "DELETE from wp_cty_260_us12k_444x336  where GeometryType(geom_900921)!='MULTILINESTRING';\n" >> ${output_dir}/temp_files/${surg_code}_create_wp_cty.sql
...
printf "SELECT AddGeometryColumn('public', 'wp_cty_cell_${surg_code}_${grid}', 'geom_${grid_proj}', ${grid_proj},'MultiLineString', 2);\n" >> ${output_dir}/temp_files/${surg_code}_create_wp_cty_cell.sql
...
printf "\trownum,\n" >>  ${output_dir}/temp_files/${surg_code}_create_wp_cty_cell.sql
  printf "\t0.0,\n" >> ${output_dir}/temp_files/${surg_code}_create_wp_cty_cell.sql
printf "\tCASE\n" >>  ${output_dir}/temp_files/${surg_code}_create_wp_cty_cell.sql
printf "\twhen ST_CoveredBy(wp_cty_${surg_code}_${grid}.geom_${grid_proj},${grid_table}.gridcell)\n" >>  ${output_dir}/temp_files/${surg_code}_create_wp_cty_cell.sql
printf "\tTHEN wp_cty_${surg_code}_${grid}.geom_${grid_proj}\n" >>  ${output_dir}/temp_files/${surg_code}_create_wp_cty_cell.sql
printf "\tELSE  \n" >>  ${output_dir}/temp_files/${surg_code}_create_wp_cty_cell.sql
printf "\t\tST_Multi(ST_Intersection(wp_cty_${surg_code}_${grid}.geom_${grid_proj},${grid_table}.gridcell)) \n" >>  ${output_dir}/temp_files/${surg_code}_create_wp_cty_cell.sql
printf "\tEND AS geom_${grid_proj} \n" >>  ${output_dir}/temp_files/${surg_code}_create_wp_cty_cell.sql
printf "  FROM wp_cty_${surg_code}_${grid}\n" >>  ${output_dir}/temp_files/${surg_code}_create_wp_cty_cell.sql
printf "  JOIN ${grid_table} \n" >>  ${output_dir}/temp_files/${surg_code}_create_wp_cty_cell.sql
printf "    ON (NOT ST_Touches(wp_cty_${surg_code}_${grid}.geom_${grid_proj},${grid_table}.gridcell)\n" >>  ${output_dir}/temp_files/${surg_code}_create_wp_cty_cell.sql
printf "        AND ST_Intersects(wp_cty_${surg_code}_${grid}.geom_${grid_proj},${grid_table}.gridcell));\n" >>  ${output_dir}/temp_files/${surg_code}_create_wp_cty_cell.sql
