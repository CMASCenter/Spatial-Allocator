...
printf "DROP TABLE IF EXISTS $schema.wp_cty_${surg_code}_${grid}; \n" > ${output_dir}/temp_files/${surg_code}_create_wp_cty.sql
printf "DROP TABLE IF EXISTS $schema.wp_cty_${surg_code}_${grid}; \n" > ${output_dir}/temp_files/${surg_code}_create_wp_cty.sql
printf "CREATE TABLE $schema.wp_cty_${surg_code}_${grid}(\n" >> ${output_dir}/temp_files/${surg_code}_create_wp_cty.sql
...
printf "INSERT INTO $schema.wp_cty_${surg_code}_${grid} ($weight_attribute, geom_${grid_proj}) \n">> ${output_dir}/temp_files/${surg_code}_create_wp_cty.sql
printf "SELECT  \n">> ${output_dir}/temp_files/${surg_code}_create_wp_cty.sql
printf "\t${weight_table}.$weight_attribute, \n">> ${output_dir}/temp_files/${surg_code}_create_wp_cty.sql
printf "\t${weight_table}.geom_${grid_proj} \n">> ${output_dir}/temp_files/${surg_code}_create_wp_cty.sql
printf "FROM ${weight_table};\n">> ${output_dir}/temp_files/${surg_code}_create_wp_cty.sql
printf "update $schema.wp_cty_${surg_code}_${grid} \n">> ${output_dir}/temp_files/${surg_code}_create_wp_cty.sql
printf "set $data_attribute=${data_table}.$data_attribute\n">> ${output_dir}/temp_files/${surg_code}_create_wp_cty.sql
printf "FROM ${data_table}\n">> ${output_dir}/temp_files/${surg_code}_create_wp_cty.sql
printf "WHERE ST_Contains(${data_table}.geom_$grid_proj, $schema.wp_cty_${surg_code}_${grid}.geom_${grid_proj});\n">> ${output_dir}/temp_files/${surg_code}_create_wp_cty.sql
printf "create index on public.wp_cty_${surg_code}_${grid} using GIST(geom_${grid_proj});\n" >> ${output_dir}/temp_files/${surg_code}_create_wp_cty.sql
printf "vacuum analyze $schema.wp_cty_${surg_code}_${grid};\n">> ${output_dir}/temp_files/${surg_code}_create_wp_cty.sql
printf "DELETE FROM $schema.wp_cty_${surg_code}_${grid} where $schema.wp_cty_${surg_code}_${grid}.$data_attribute IS NULL;\n">> ${output_dir}/temp_files/${surg_code}_create_wp_cty.sql
