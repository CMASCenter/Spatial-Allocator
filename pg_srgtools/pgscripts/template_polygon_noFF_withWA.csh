...
printf "DROP TABLE IF EXISTS ${schema_name}.wp_cty_${surg_code}_${grid};\n" > ${output_dir}/temp_files/${surg_code}_create_wp_cty.sql
printf "CREATE TABLE ${schema_name}.wp_cty_${surg_code}_${grid}\n" >> ${output_dir}/temp_files/${surg_code}_create_wp_cty.sql
...
#printf "SELECT AddGeometryColumn('public', 'wp_cty_${surg_code}_${grid}', 'geom_${grid_proj}', ${grid_proj},'MultiPolygon', 2);\n" >> ${output_dir}/temp_files/${surg_code}_create_wp_cty.sql
printf "SELECT AddGeometryColumn('${schema_name}', 'wp_cty_${surg_code}_${grid}', 'geom_${srid_final}', ${srid_final}, 'MultiPolygon', 2);\n" >> ${output_dir}/temp_files/${surg_code}_create_wp_cty.sql

printf "insert into ${schema_name}.wp_cty_${surg_code}_${grid}\n" >> ${output_dir}/temp_files/${surg_code}_create_wp_cty.sql
...
printf "update  ${schema_name}.wp_cty_${surg_code}_${grid} set area_${srid_final}=ST_Area(geom_${srid_final});\n"  >> ${output_dir}/temp_files/${surg_code}_create_wp_cty.sql
printf "update  ${schema_name}.wp_cty_${surg_code}_${grid} set\n" >> ${output_dir}/temp_files/${surg_code}_create_wp_cty.sql
...
printf "\tvacuum analyze ${schema_name}.wp_cty_${surg_code}_${grid};" >> ${output_dir}/temp_files/${surg_code}_create_wp_cty.sql
...
printf "\t\tEND AS geom_${srid_final}\n" >> ${output_dir}/temp_files/${surg_code}_create_wp_cty_cell.sql
printf "\tFROM public.wp_cty_${surg_code}_${grid}\n" >> ${output_dir}/temp_files/${surg_code}_create_wp_cty_cell.sql
