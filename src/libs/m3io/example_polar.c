/*
example_polar.c - Demonstrate usage of createPolarM3IOFile().
cc -I. -o example_polar example_polar.c M3IO.c libnetcdf.a
./example_polar
ncdump example_polar.ncf
*/
...
int main( void ) {
  const char* const fileName = "example_polar.ncf";
  enum {
  ...
  const int file =
    createPolarM3IOFile(
      ...
      centralLongitude, secantLatitude, isNorthern,
