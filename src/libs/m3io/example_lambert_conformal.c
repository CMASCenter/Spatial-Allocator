/*
example_lambert_conformal.c - Demonstrate createLambertConformalM3IOFile().
cc -I. -o example_lambert_conformal example_lambert_conformal.c M3IO.c \
   libnetcdf.a
./example_lambert_conformal
ncdump example_lambert_conformal.ncf
*/

#include <M3IO.h> /* For Name, Line, createLambertConformalM3IOFile(). */


int main( void ) {
  const char* const fileName = "example_lambert_conformal.ncf";
  enum {
