/*
example_albers_equal_area.c - Demonstrate createAlbersEqualAreaM3IOFile().
cc -I. -o example_albers_equal_area example_albers_equal_area.c M3IO.c \
   libnetcdf.a
./example_albers_equal_area
ncdump example_albers_equal_area.ncf
*/

#include <M3IO.h> /* For Name, Line, createAlbersEqualAreaM3IOFile(). */


int main( void ) {
  const char* const fileName = "example_albers_equal_area.ncf";
  enum {
