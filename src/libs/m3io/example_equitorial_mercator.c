/*
example_equitorial_mercator.c - Demonstrate createEquitorialMercatorM3IOFile().
cc -I. -o example_equitorial_mercator example_equitorial_mercator.c M3IO.c \
   libnetcdf.a
./example_equitorial_mercator
ncdump example_equitorial_mercator.ncf
*/

#include <M3IO.h> /* For createEquitorialMercatorM3IOFile(). */


int main( void ) {
  const char* const fileName = "example_equitorial_mercator.ncf";
  enum {
  ...
  const int file =
    createEquitorialMercatorM3IOFile(
